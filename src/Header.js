	...
	return (
		<div className="header">
			...
			<div className="header__searchBox">
				<TextField className="header__input" placeholder="Search" variant="outlined" color = "secondary" />
				<Button variant="outlined" className="header__searchBtn">
					<SearchIcon />
				</Button>
			</div>
			...
			<div className="header__rightSide">
				<VideoCall className = "header__videoCall"/>
				<AppIcon className = "header__appIcon"/>
